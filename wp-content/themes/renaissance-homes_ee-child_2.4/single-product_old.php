   ...
   <div class="product-types clearfix">
     ...
     <div class="description">
      ...
      <?php if ($et_bedrooms_number <> '') { ?>
         <span class="bed-icon"><?php echo $et_bedrooms_number; ?> <?php _e('Bedroom','ElegantEstate');  ?></span>
      <?php } ?>
      <?php if ($et_bathrooms_number <> '') { ?>
         <span class="bath-icon"><?php echo $et_bathrooms_number; ?> <?php _e('Bathroom','ElegantEstate');  ?></span>
      <?php } ?>
      <?php if ($et_garages_number <> '') { ?>
           <span class="garage-icon"><?php echo $et_garages_number; ?> <?php _e('Garage','ElegantEstate');  ?></span>
        <?php } ?>
      <?php if ($et_square_footage <> '') { ?>
         <span class="ruler-icon"><?php echo $et_square_footage; ?> <?php _e('ft2','ElegantEstate');  ?></span>
      <?php } ?>
   </div> <!-- .product-types -->
...
<p><?php $category = get_the_category();
						  if (!empty($category)) { 
								...
								echo ('<a href="'.$catlink.'+quick-move-ins">Quick Move-Ins</a>');
						  }; ?></p>
                          
                          <p><a href=category/<?php echo the_slug(); ?>+quick-move-ins><?php $category = get_the_category(); 
								echo $category[0]->cat_name;?> Floor Plans</a></p>
                          
                          <p><a href=/contact-community-manager>Contact Community Manager</a></p>
