...
if (in_array($postid, $myfavcheck)) { ?>
  ...
  <a href="/myfav?remove&fav=<?php echo $_COOKIE['myfav'];?>" onClick="myfav_remove<?php echo $postid; ?>();">Remove from Favorites</a>
  
  <?php } else { ?>
  
  <a href="/myfav?add&fav=<?php echo $_COOKIE['myfav'];?>" onClick="myfav_add<?php echo $postid; ?>();">Add to Favorites</a
