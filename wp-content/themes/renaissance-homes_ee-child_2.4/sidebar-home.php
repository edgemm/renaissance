...
<h4 class ="widgettitle">Find Your Home Now</h4>

<form name="range_form" method="post" id="range_form" action="/move-in-ready" onsubmit="return saveScrollPositions(this);">
<div class="default-filter">

<input type="hidden" name="scrollx" id="scrollx" value="0" />
<input type="hidden" name="scrolly" id="scrolly" value="0" />    
    
    Price: $<input name="amount1" type="text" id="amount1" >,000 - $<input name="amount2" type="text" id="amount2" >,000<span class="rh-mir-gte">+</span>
    ...
    <div class="hidden">Garages: <input name="car1" type="text" id="car1" > - <input name="car2" type="text" id="car2" ></div>
    <div id="car" class="hidden"></div>
...
<div id="save-share" class="home-mod">
    <a href="/move-in-ready" class="read-more btn-orange-lrg home-begin-search" >Begin Your Search</a>  
</div>
...
var amountCap = 1200; // cap for home cost  - gfh
...
function priceValuesSubmit() { // set values of price to nubmers without commas - gfh
	...
	$( "#save-share a.home-begin-search" ).click(function( e ) {
	    e.preventDefault();
	    priceValuesSubmit();
	});
    });
