...
var myfavremove = myfavsave.split(',<?php echo $postid; ?>').join('');

var myfavremove2 = myfavremove.replace("null","");
...
var newUrl = _href + myfavsave

$('#addmyfav<?php echo $postid; ?>').replaceWith('<div class="addmyfav" id="addmyfav<?php echo $postid; ?>"><p>~Processing~</p></div>') 
